report 50004 "QRS Sales-Quote Without Disc"
{
    RDLCLayout = './SalesQuoteWithoutDisc.rdlc';
    WordLayout = './SalesQuoteWithoutDisc.docx';
    Caption = 'Sales - Quote';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(FOBOrigin; FOBOrigin)
                {

                }
                column(LeadTimeLbl; LeadTime)
                {
                ...
                column(TotalAmountExcDisc; TotalAmountExcDiscText)
                {
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                }
                ...
                column(Lead_Time; FORMAT("Lead Times"))
                {
                ...
                begin
                    ...
                    TotalAmountExcDisc := Amount + "Line Discount Amount";
                    TotalSubTotalExcDisc += TotalAmountExcDisc;
                    TotalAmountTotalExcDisc := TotalSubTotalExcDisc + TotalAmountVAT;
                    TotalAmountExcDiscText := Format(TotalAmountExcDisc, 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code"));
                    ...
                    if Type = Type::" " then begin
                        FormatTaxAmount := '';
                        FormattedUnitPrice := '';
                        TotalAmountExcDiscText := '';
                    end else begin
                        FormatTaxAmount := '$ ' + FORMAT(("Amount Including VAT" - Amount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code"));
                        FormattedUnitPrice := '$ ' + FormattedUnitPrice;
                        TotalAmountExcDiscText := '$ ' + TotalAmountExcDiscText;
                    end;

                    if FormattedUnitPrice = '' then begin
                        TotalAmountExcDiscText := '';
                    end;
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalVATAmount; '$ ' + FORMAT((TotalAmountVAT), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code")))
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
                ...
                column(TotalSubTotalExcDisc; '$ ' + FORMAT((TotalSubTotalExcDisc), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code")))
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
                ...
                column(TotalAmountTotalExcDisc; '$ ' + FORMAT((TotalAmountTotalExcDisc), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code")))
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
            ...
            begin
                ...
                TotalAmountExcDisc := 0;
                TotalSubTotalExcDisc := 0;
                TotalAmountTotalExcDisc := 0;
            end;
    ...
    var
        ...
        ItemLogo: Label 'Item Picture';

        LeadTime: Label 'Lead Time';

        Discount: Label 'Discount %';

        FOBOrigin: Label 'Shipping & Handling';
        ...
        TotalAmountExcDisc: Decimal;

        TotalAmountExcDiscText: Text;

        TotalSubTotalExcDisc: Decimal;

        TotalAmountTotalExcDisc: Decimal;
