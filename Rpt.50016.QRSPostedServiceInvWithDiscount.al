report 50016 "Posted Service Inv With Disc"
{
    DefaultLayout = Word;
    //RDLCLayout = './ServiceInvoice.rdlc';
    WordLayout = './PostedServiceInvoiceWithDisc.docx';
    PreviewMode = PrintLayout;
    Caption = 'Posted Service Inv With Discount';
    ...
    dataset
    {
        dataitem("Service Invoice Header"; "Service Invoice Header")
        {
            ...
            dataitem("Service Invoice Line"; "Service Invoice Line")
            {
                ...
                column(MnfgItemNo; "QRS Mnfg ItemNo")
                {

                }
                column(MnfgName; "QRS Mnfg Name")
                {

                }
                column(CustomerRefNo; "Customer Ref No")
                {
                ...
                column(Service_Item_Description; DescriptionText)
                {
                ...
                column(Unit_Price; FormattedUnitPrice)
                {

                }
                column(Amount_Including_VAT; FormattedLineAmount)
                {

                }
                column(VAT; FormattedVATPercentage)
                {
                ...
                column(Disc_Amount; "Line Discount Amount")
                {
                ...
                begin
                    ...
                    //CV_SSV>>
                    if recServiceItem.Get("Service Invoice Line"."Service Item No.") then;
                    ...
                    if Type = Type::" " then begin
                        ...
                        FormattedUnitPrice := '$ ' + Format("Unit Price", 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Invoice Header"."Currency Code"));
                        FormattedLineAmount := '$ ' + Format(("Amount Including VAT"), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Invoice Header"."Currency Code"));
                        FormattedVATPercentage := '$ ' + FORMAT(("Amount Including VAT" - Amount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Invoice Header"."Currency Code"));
                        FormattedDiscAmount := '$ ' + FORMAT("Line Discount Amount", 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Invoice Header"."Currency Code"));
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(OrderDate_ServInvHdr; Format("Service Invoice Header"."Order Date"))
                    {
                    }
                    ...
                    column(DocDate_ServInvHdr; FORMAT("Service Invoice Header"."Document Date"))
                    {
                    }
                    ...
                    column(PackageIDNo; "Service Invoice Header"."Package ID No.")
                    {

                    }
                    column(CustomerPONo; "Service Invoice Header"."Customer PO No.")
                    {
                    ...
                    dataitem(ServInvLine; "Integer")
                    {
                        ...
                        column(TempServInvLineDescription; TempServInvoiceLine."Service Item Line Description")
                        {
                        }
                        ...
                        begin
                            ...
                            with TempServInvoiceLine do begin
                                ...
                                TotalGrossAmount += "Amount Including VAT";
                    ...
                    {
                        DataItemTableView = SORTING(Number) WHERE(Number = CONST(1));
                        column(TotalAmount; '$ ' + FORMAT((TotalAmount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Invoice Header"."Currency Code")))
                        {

                        }
                        column(TotalVatAmount; '$ ' + FORMAT((TotalVatAmount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Invoice Header"."Currency Code")))
                        {
                        }
                        column(TotalGrossAmount; '$ ' + FORMAT((TotalGrossAmount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Invoice Header"."Currency Code")))
                        {
                        }
    ...
    var
        ...
        FormattedLineAmount: Text[30];
        FormattedUnitPrice: Text[30];
        FormattedVATPercentage: Text[30];
        FormattedDiscAmount: Text[30];
        SerialNo: Code[30];
