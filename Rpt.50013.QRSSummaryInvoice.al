report 50013 "QRS Summary Service Invoice"
{
    DefaultLayout = Word;
    RDLCLayout = './SummaryInvoice.rdlc';
    WordLayout = './QRSSummaryInvoice.docx';
    PreviewMode = PrintLayout;
    Caption = 'Summary Service Invoice';
    ...
    dataset
    {
        dataitem("Service Invoice Header"; "Service Invoice Header")
        {
            ...
            dataitem("Service Invoice Line"; "Service Invoice Line")
            {
                ...
                column(Service_Item_Description; "Service Item Line Description")
                {
                ...
                begin
                    ...
                    if Type = Type::" " then begin
                        ...
                        FormattedUnitPrice := Format("Unit Price");
                        FormattedLineAmount := Format("Amount Including VAT");
                        FormattedVATPercentage := Format("VAT %");
                    end;
                    ...
                    dataitem(ServInvLine; "Integer")
                    {
                        ...
                        begin
                            ...
                            with TempServInvoiceLine do begin
                                ...
                                ItemDescription := 'Calibration Services rendered on ' + Format("Posting Date");
                                ...
                                TotalVatAmount += TotalGrossAmount - TotalAmount;
