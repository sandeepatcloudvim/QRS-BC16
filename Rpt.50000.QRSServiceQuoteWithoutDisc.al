report 50000 "QRS Service Quote "
{

    WordLayout = './QRSServiceQuoteWithoutDisc.docx';
    RDLCLayout = './ServiceQuoteQRS.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Service Line"; "Service Line")
                    {
                        ...
                        column(Service_Line__Unit_Price_; UnitPriceText)
                        {
                        }
                        ...
                        column(Manufacturer; "QRS Mnfg Name")
                        {
                        ...
                        column(QRS_Mnfg_ItemNo; "QRS Mnfg ItemNo")
                        {

                        }
                        column(QRS_Mnfg_Name; "QRS Mnfg Name")
                        {
                        ...
                        begin
                            ...
                            TotalAmountExcDisc := Amt + "Line Discount Amount";
                            TotalSubTotalExcDisc += TotalAmountExcDisc;
                            TotalAmountTotalExcDisc := TotalSubTotalExcDisc + VATAmount;
                            ...
                            if Type = Type::" " then begin
                                ...
                                UnitPriceText := '$ ' + FORMAT(("Unit Price"), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Header"."Currency Code"));
                                TotalAmountExcDiscText := '$ ' + FORMAT((TotalAmountExcDisc), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Header"."Currency Code"));
                            end;
                    ...
                    dataitem(Totals; "Integer")
                    {
                        ...
                        column(TotalSubTotalExcDisc; '$ ' + FORMAT((Round(TotalSubTotalExcDisc, 0.01, '=')), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Header"."Currency Code")))
                        {

                        }
                        column(TotalAmountTotalExcDisc; '$ ' + FORMAT((Round(TotalAmountTotalExcDisc, 0.01, '=')), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Header"."Currency Code")))
                        {
