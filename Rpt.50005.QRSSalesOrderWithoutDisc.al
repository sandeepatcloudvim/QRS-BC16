report 50005 "QRS Sales-Order Without Disc"
{
    RDLCLayout = './SalesOrderWithoutDisc.rdlc';
    WordLayout = './SalesOrderWithoutDisc.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(TotalAmountExcDisc; TotalAmountExcDisc1)
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                ...
                column(VATPct_Line; FormatTaxAmount)
                {
                }
                ...
                begin
                    ...
                    TotalAmountExcDisc1 := FORMAT(TotalAmountExcDisc, 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code"));
                    ...
                    if Type = Type::" " then begin
                        ...
                        TotalAmountExcDisc1 := '$ ' + TotalAmountExcDisc1;
                    end;
