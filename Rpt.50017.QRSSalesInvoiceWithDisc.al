report 50017 "QRS Sales Invoice With Disc"
{
    RDLCLayout = './QRSStandSalesInvoice.rdlc';
    WordLayout = './QRSStandSalesInvoicewithDisc.docx';
    Caption = 'Sales Invoice With Disc';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(LineDiscount; FormattedDiscAmount)
                {
                }
                column(LineDiscountPercentText_Line; LineDiscountPctText)
                {
                }
                column(LineAmount_Line; FormattedLineAmountText)
                {
                ...
                column(UnitPrice; FormattedUnitPriceText)
                {
                ...
                begin
                    ...
                    if Type = Type::" " then begin
                        FormatTaxAmount := '';
                        FormattedUnitPriceText := '';
                        FormattedLineAmountText := '';
                        FormattedDiscAmount := ''
                    end else begin
                        ...
                        FormattedUnitPriceText := '$ ' + FORMAT("Unit Price", 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code"));
                        FormattedLineAmountText := '$ ' + FORMAT("Line Amount", 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code"));
                        FormattedDiscAmount := '$ ' + FORMAT("Line Discount Amount", 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code"));
                    end;
            ...
            dataitem(ReportTotalsLine; "Report Totals Buffer")
            {
                ...
                column(Amount_ReportTotalsLine; '$ ' + FORMAT((Amount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code")))
                {
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalAmountExclInclVAT; '$ ' + FORMAT((TotalAmountExclInclVATValue), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code")))
                {
    ...
    var
        ...
        FormattedDiscAmount: Text;
        FormattedUnitPrice: Text;
        FormattedUnitPriceText: Text;
        FormattedQuantity: Text;
        FormattedLineAmount: Text;
        FormattedLineAmountText: Text;
