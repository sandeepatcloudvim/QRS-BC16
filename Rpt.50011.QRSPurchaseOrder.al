report 50011 "QRS Purchase Order"
{
    RDLCLayout = './PurchaseOrder.rdlc';
    WordLayout = './QRSPurchaseOrder.docx';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(LineAmt_PurchLine; LineAmountText)
                {
                    AutoFormatExpression = "Purchase Header"."Currency Code";
                    AutoFormatType = 1;
                }
                ...
                begin
                    ...
                    if "Purchase Line".Type = "Purchase Line".Type::" " then begin
                        ...
                        LineAmountText := '$ ' + FORMAT(("Line Amount"), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Purchase Header"."Currency Code"));
                    end;
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalSubTotal; '$ ' + FORMAT((TotalSubTotal), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Purchase Header"."Currency Code")))
                {
                    AutoFormatExpression = "Purchase Header"."Currency Code";
                    AutoFormatType = 1;
                }
                column(TotalInvoiceDiscountAmount; '$ ' + FORMAT((TotalInvoiceDiscountAmount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Purchase Header"."Currency Code")))
                {
                    AutoFormatExpression = "Purchase Header"."Currency Code";
                    AutoFormatType = 1;
                }
                column(TotalAmount; '$ ' + FORMAT((TotalAmount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Purchase Header"."Currency Code")))
                {
                    AutoFormatExpression = "Purchase Header"."Currency Code";
                    AutoFormatType = 1;
                }
                ...
                column(TaxAmount; '$ ' + FORMAT((TaxAmount), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Purchase Header"."Currency Code")))
                {
                }
