report 50001 "QRS Sales Quote With Discounts"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(LineDiscountPercent_Line; FormatDiscount)
                {
                }
                ...
                begin
                    ...
                    if Type = Type::" " then begin
                        ...
                        FormatDiscount := '$ ' + FORMAT("Line Discount Amount", 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code"));
                    end;
