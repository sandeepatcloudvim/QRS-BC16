report 50009 "Posted Service Invoice"
{
    DefaultLayout = Word;
    RDLCLayout = './ServiceInvoice.rdlc';
    WordLayout = './PostedServiceInvoice.docx';
    ...
    dataset
    {
        dataitem("Service Invoice Header"; "Service Invoice Header")
        {
            ...
            dataitem("Service Invoice Line"; "Service Invoice Line")
            {
                ...
                column(MnfgItemNo; MnfgItemNo)
                {

                }
                column(MnfgName; MnfgItemName)
                {

                }
                column(CustomerRefNo; CustomerRefNo)
                {
                ...
                column(FormattedVATPercentage; FormattedVATPercentage)
                {
