report 50002 "QRS Sales Order With Discounts"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(LineDiscountPercent_Line; FormattedLineAmount)
                {
                }
                ...
                column(Line_Discount__; FormattedDiscAmount)
                {
                ...
                begin
                    ...
                    if Type = Type::" " then begin
                        ...
                        FormattedLineAmount := '$ ' + FormattedLineAmount;
            ...
            dataitem(VATAmountLine; "VAT Amount Line")
            {
                ...
                column(VATAmount_VatAmountLine; '$ ' + FORMAT(("VAT Amount"), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code")))
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalAmountIncludingVAT; '$ ' + FORMAT((TotalAmountInclVAT), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code")))
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
