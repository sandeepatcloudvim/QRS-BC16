pageextension 50011 QRSServiceQuoteSubform extends "Service Quote Subform"
{
    layout
    {
        addafter("Serial No.")
    ...
    procedure ShowAllServQuoteWorksheet()
    var
    ...
    begin
        ...
        ServiceItemLine.SETRANGE("Document Type", ServiceItemLine."Document Type"::Quote);
        ...
        IF ServiceItemLine.FINDFIRST THEN
            REPEAT
                ...
                ServiceLine.INIT;
                ServiceLine."Document Type" := enumServiceDocument::Quote;
                ServiceLine."Document No." := ServiceItemLine."Document No.";
                ServiceLine."Customer No." := ServiceItemLine."Customer No.";
                ServiceLine."Line No." := GetLastItemNo(enumServiceDocument::Quote);
