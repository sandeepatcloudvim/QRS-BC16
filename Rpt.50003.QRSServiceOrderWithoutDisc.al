report 50003 "QRS Service Order"
{
    DefaultLayout = Word;
    RDLCLayout = './ServiceOrder.rdlc';
    WordLayout = './QRSServiceOrderWithoutDisc.docx';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Service Item Line"; "Service Item Line")
                    {
                        ...
                        column(ServiceItem_Manufacurer; MnfgName)
                        {
                    ...
                    dataitem("Service Line"; "Service Line")
                    {
                        ...
                        column(UnitPrice_ServLine; UnitPriceFormat)
                        {
                        }
                        ...
                        begin
                            ...
                            if Type = Type::" " then begin
                                ...
                                UnitPriceFormat := '$ ' + FORMAT(("Unit Price"), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, "Service Header"."Currency Code"));
                    ...
                    dataitem(Totals; "Integer")
                    {
                        ...
                        column(TotalSubTotalExcDisc; '$ ' + FORMAT((TotalGrossAmt - VATAmount), 0, '<Precision,2><sign><Integer Thousand><Decimals,3>'))
                        {

                        }
                        column(TotalAmountTotalExcDisc; '$ ' + FORMAT((TotalAmountTotalExcDisc), 0, '<Precision,2><sign><Integer Thousand><Decimals,3>'))
                        {
